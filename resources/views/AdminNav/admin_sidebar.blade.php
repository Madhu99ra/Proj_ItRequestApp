  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-sidebar" data-widget="treeview" role="menu" data-accordion="false" id="sidebar-menu">
        ...
        <li id="nav-item3">
          <a href="adminviewrequest" class="nav-link">
            <p>
              View Request
            </p>
          </a>
        ...
        <li id="nav-item4">
          <a href="admincompletedrequest" class="nav-link">
            <p>
              Completed Request
            </p>
          </a>
...
<script>
  // Function to set the highlighted class to the clicked item and store its id in local storage
