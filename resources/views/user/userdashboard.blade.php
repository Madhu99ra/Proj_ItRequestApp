      ...
      <div class="card" style="background-color: #f0f8ff;">
        <div class="card-body">
          ...
          <form action="{{ route('complete-profile') }}" method="POST">
            ...
            <input type="text" id="username" name="username" value="{{ $data->username }}" disabled><br><br>
            ...
            <input type="text" id="department" name="department" value="{{ $data->department }}"><br><br>
            <label for="post">Post:</label><br>
            <input type="text" id="post" name="post" value="{{ $data->post }}"><br><br>
